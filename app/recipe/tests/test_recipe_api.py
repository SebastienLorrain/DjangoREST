...
def sample_recipe(user, **params):
    ...
    defaults.update(params)  # Take whatever key in the dictionary, and update.
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        sample_recipe(user=self.user, title='My other recipe')
    ...
    def test_recipies_limited_to_user(self):
        """Test retrieve recipies for user"""
...
class RecipeImageUploadTests(TestCase):
    """Test the image upload within a recipe"""
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            'test@admin.com',
    ...
    def test_upload_image_to_recipe(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as ntf:
            ...
            ntf.seek(0)  # Move back the cursor to the beginnin of the file.
